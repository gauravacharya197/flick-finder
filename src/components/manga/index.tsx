  ...
  const {
    ...
    queryFn: async () => {
      ...
      if (sortOption === "newest") {
        sortedData.sort((a, b) => new Date(b.releasedDate).getTime() - new Date(a.releasedDate).getTime());
      } else if (sortOption === "oldest") {
        sortedData.sort((a, b) => new Date(a.releasedDate).getTime() - new Date(b.releasedDate).getTime());
